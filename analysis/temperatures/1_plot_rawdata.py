...
True raw data from the loggers is not used since I found no way to map their position.

This script also uploads and plots the data from the doorway.
It creates and stores one data frame per experiment in 'Temperatures_Condensed.pkl'
"""
